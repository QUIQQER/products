...
define('package/quiqqer/products/bin/controls/fields/types/PriceByQuantitySettings', [
    ...
    'css!package/quiqqer/products/bin/controls/fields/types/PriceByQuantitySettings.css'
    ...
    return new Class({
        ...
        $onInject: function () {
            ...
            this.$Groups = new GroupSelect({
                ...
                this.$Elm.getElement('.quiqqer-products-priceByQuantity-settings-groups-values')
            );
